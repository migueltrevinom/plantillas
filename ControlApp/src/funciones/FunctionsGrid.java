...
public class FunctionsGrid extends BaseAdapter {
private Context mContext;

public  FunctionsGrid(Context c) {
    mContext = c;
}
...
private Integer[] mThumbIds = {
        R.drawable.funcwrite,R.drawable.funcmouse,R.drawable.media, R.drawable.presentation
};
